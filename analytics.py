...
@app.route('/vocnews')
def vocnews():
    pl = PageView.select(PageView.title,fn.Min(PageView.loadtime).alias('mload')).where((PageView.loadtime != '') & (PageView.domain == '127.0.0.1:5010')).group_by(PageView.title).order_by(fn.Min(PageView.loadtime).asc()).dicts()
    tpg = PageView.select(PageView.title, fn.Count(PageView.id).alias('tpc')).where((PageView.title != '') & (PageView.domain == '127.0.0.1:5010')).group_by(PageView.title).order_by(fn.Count(PageView.id).desc()).tuples()
    tpg_m = PageView.select(PageView.title,fn.Max(PageView.docmodified)).where((PageView.title != '') & (PageView.domain == '127.0.0.1:5010')).group_by(PageView.title).order_by(fn.Count(PageView.id).desc()).tuples()
    appname = PageView.select(PageView.bappname, fn.Count(PageView.id).alias('appcnt')).where((PageView.bappname != '') & (PageView.domain == '127.0.0.1:5010')).group_by(PageView.bappname).order_by(fn.Count(PageView.id).desc()).tuples()
    tref = PageView.select(PageView.referrer, fn.Count(PageView.id).alias('refcnt')).where((PageView.referrer != '') & (PageView.domain == '127.0.0.1:5010')).group_by(PageView.referrer).order_by(fn.Count(PageView.id).desc()).tuples()
    tip = PageView.select(PageView.ip, fn.Count(PageView.id).alias('ipcnt')).where((PageView.ip != '') & (PageView.domain == '127.0.0.1:5010')).group_by(PageView.ip).order_by(fn.Count(PageView.id).desc()).tuples()
    hour = fn.date_part('hour', PageView.timestamp)
    id_count = fn.Count(PageView.id)
    mthr = PageView.select(hour.alias('hour'), id_count.alias('hcnt')).where(PageView.domain == '127.0.0.1:5010').group_by(hour).order_by(hour.asc()).dicts()
    bname = PageView.select(PageView.bappname.alias('brow'), fn.Count(PageView.id).alias('browcnt')).where((PageView.bappname != '') & (PageView.domain == '127.0.0.1:5010')).group_by(PageView.bappname).order_by(fn.Count(PageView.id).desc()).dicts()
    day = fn.date_part('day', PageView.timestamp)
    dmthr = PageView.select(day.alias('day'), id_count.alias('dycnt')).where(PageView.domain == '127.0.0.1:5010').group_by(day).order_by(day.asc()).dicts()
    tos = PageView.select(PageView.regtry.alias('osname'),fn.Count(PageView.id).alias('oscnt')).where((PageView.regtry != '') & (PageView.domain == '127.0.0.1:5010')).group_by(PageView.regtry).order_by(fn.Count(PageView.id).desc()).dicts()
    hd = PageView.select(PageView.headers,fn.Count(PageView.id).alias('uacnt')).where((PageView.headers != '') & (PageView.domain == '127.0.0.1:5010')).group_by(PageView.headers).order_by(fn.Count(PageView.id).desc()).tuples()
...
@app.route('/vocinfo')
def vocinfo():
    pl = PageView.select(PageView.title,fn.Min(PageView.loadtime).alias('mload')).where((PageView.loadtime != '') & (PageView.domain == '127.0.0.1:5020')).group_by(PageView.title).order_by(fn.Min(PageView.loadtime).asc()).dicts()
    tpg = PageView.select(PageView.title, fn.Count(PageView.id).alias('tpc')).where((PageView.title != '') & (PageView.domain == '127.0.0.1:5020')).group_by(PageView.title).order_by(fn.Count(PageView.id).desc()).tuples()
    tpg_m = PageView.select(PageView.title,fn.Max(PageView.docmodified)).where((PageView.title != '') & (PageView.domain == '127.0.0.1:5020')).group_by(PageView.title).order_by(fn.Count(PageView.id).desc()).tuples()
    appname = PageView.select(PageView.bappname, fn.Count(PageView.id).alias('appcnt')).where((PageView.bappname != '') & (PageView.domain == '127.0.0.1:5020')).group_by(PageView.bappname).order_by(fn.Count(PageView.id).desc()).tuples()
    tref = PageView.select(PageView.referrer, fn.Count(PageView.id).alias('refcnt')).where((PageView.referrer != '') & (PageView.domain == '127.0.0.1:5020')).group_by(PageView.referrer).order_by(fn.Count(PageView.id).desc()).tuples()
    tip = PageView.select(PageView.ip, fn.Count(PageView.id).alias('ipcnt')).where((PageView.ip != '') & (PageView.domain == '127.0.0.1:5020')).group_by(PageView.ip).order_by(fn.Count(PageView.id).desc()).tuples()
    hour = fn.date_part('hour', PageView.timestamp)
    id_count = fn.Count(PageView.id)
    mthr = PageView.select(hour.alias('hour'), id_count.alias('hcnt')).where(PageView.domain == '127.0.0.1:5020').group_by(hour).order_by(hour.asc()).dicts()
    bname = PageView.select(PageView.bappname.alias('brow'), fn.Count(PageView.id).alias('browcnt')).where((PageView.bappname != '') & (PageView.domain == '127.0.0.1:5020')).group_by(PageView.bappname).order_by(fn.Count(PageView.id).desc()).dicts()
    day = fn.date_part('day', PageView.timestamp)
    dmthr = PageView.select(day.alias('day'), id_count.alias('dycnt')).where(PageView.domain == '127.0.0.1:5020').group_by(day).order_by(day.asc()).dicts()
    tos = PageView.select(PageView.regtry.alias('osname'),fn.Count(PageView.id).alias('oscnt')).where((PageView.regtry != '') & (PageView.domain == '127.0.0.1:5020')).group_by(PageView.regtry).order_by(fn.Count(PageView.id).desc()).dicts()
    hd = PageView.select(PageView.headers,fn.Count(PageView.id).alias('uacnt')).where((PageView.headers != '') & (PageView.domain == '127.0.0.1:5020')).group_by(PageView.headers).order_by(fn.Count(PageView.id).desc()).tuples()
